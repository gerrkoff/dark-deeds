...
// task focused at all, does it carry a date (so a day-move is meaningful), and the text to seed the edit
// and move editors plus the date an add inherits. The application, which owns the projection and focus,
// fills this in for every key press.
