...
export class OAuthAuthorizeRequestService {
    ...
    parse(search: string): OAuthAuthorizeRequest | null {
...
export const oauthAuthorizeRequestService = new OAuthAuthorizeRequestService()
