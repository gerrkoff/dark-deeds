...
export const signin = createAsyncThunk(
    'login/signin',
    async ({ username, password }: { username: string; password: string }): Promise<SigninResultDto> => {
...
export const signup = createAsyncThunk(
    'login/signup',
    async ({ username, password }: { username: string; password: string }): Promise<SignupResultDto> => {
