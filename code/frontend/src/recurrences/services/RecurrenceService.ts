...
export class RecurrenceService {
    ...
    print(recurrence: PlannedRecurrenceModel): PlannedRecurrencePrintModel {
        ...
        return {
            task,
            schedule: repeatative,
            borders,
        }
    }

    private printBordersPart(recurrence: PlannedRecurrenceModel): string {
        let result = ''
        const today = this.dateService.today().valueOf()
