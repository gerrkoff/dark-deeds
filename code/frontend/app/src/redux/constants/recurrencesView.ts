...
export const RECURRENCESVIEW_CREATING_RECURRENCES_FINISH =
    'RECURRENCESVIEW_CREATING_RECURRENCES_FINISH'
export interface ICreateRecurrencesFinish {
    type: typeof RECURRENCESVIEW_CREATING_RECURRENCES_FINISH
}

export const RECURRENCESVIEW_LOADING_RECURRENCES_PROCESSING =
    'RECURRENCESVIEW_LOADING_RECURRENCES_PROCESSING'
export interface ILoadRecurrencesProcessing {
    type: typeof RECURRENCESVIEW_LOADING_RECURRENCES_PROCESSING
}

export const RECURRENCESVIEW_LOADING_RECURRENCES_FAIL =
    'RECURRENCESVIEW_LOADING_RECURRENCES_FAIL'
export interface ILoadRecurrencesFail {
    type: typeof RECURRENCESVIEW_LOADING_RECURRENCES_FAIL
}

export const RECURRENCESVIEW_LOADING_RECURRENCES_SUCCESS =
    'RECURRENCESVIEW_LOADING_RECURRENCES_SUCCESS'
...
export const RECURRENCESVIEW_CHANGE_EDITTING_RECURRENCE =
    'RECURRENCESVIEW_CHANGE_EDITTING_RECURRENCE'
...
export const RECURRENCESVIEW_CHANGE_RECURRENCE =
    'RECURRENCESVIEW_CHANGE_RECURRENCE'
export interface IChangeRecurrence {
    type: typeof RECURRENCESVIEW_CHANGE_RECURRENCE
    plannedRecurrence: PlannedRecurrence
}

export const RECURRENCESVIEW_SAVING_PROCESSING =
    'RECURRENCESVIEW_SAVING_PROCESSING'
...
export const RECURRENCESVIEW_DELETE_RECURRENCE =
    'RECURRENCESVIEW_DELETE_RECURRENCE'
