...
export function openEditTaskModal(open: boolean, uid: string | null = null): actions.IEditTaskModalOpen {
...
export function openEditTaskWithModel(model: TaskModel, uid: string | null = null) {
