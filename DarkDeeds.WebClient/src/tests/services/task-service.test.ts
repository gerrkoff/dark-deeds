...
function task(year: number, month: number, date: number, id: number = 0, order: number = 0, timeType: TaskTypeEnum = TaskTypeEnum.NoTime, hours: number = 0, minutes: number = 0): Task {
...
test('[tasksEqual] positive', () => {
    ...
    expect(TaskService.tasksEqual(new Task(1, '1', null, 1, false, 1, false, false, TaskTypeEnum.NoTime, false), new Task(1, '1', null, 1, false, 1, false, false, TaskTypeEnum.NoTime, true))).not.toBeTruthy()
})

test('[sort] positive', () => {
    const tasks = [
        new Task(1, '', new Date(2018, 1, 1), 1, false, 0, false, false, TaskTypeEnum.NoTime),
        new Task(2, '', new Date(2018, 1, 1), 0, false, 0, false, false, TaskTypeEnum.NoTime, false, 0, 600),
        new Task(3, '', new Date(2018, 1, 1), 4, false, 0, false, false, TaskTypeEnum.NoTime),
        new Task(4, '', new Date(2018, 1, 1), 0, false, 0, false, false, TaskTypeEnum.NoTime, false, 0, 600),
        new Task(5, '', new Date(2018, 1, 1), 3, false, 0, false, false, TaskTypeEnum.NoTime),
        new Task(6, '', new Date(2018, 1, 1), 0, false, 0, false, false, TaskTypeEnum.NoTime, false, 0, 480),
        new Task(7, '', new Date(2018, 1, 1), 2, false, 0, false, false, TaskTypeEnum.NoTime),
        new Task(8, '', new Date(2018, 1, 1), 0, false, 0, false, false, TaskTypeEnum.NoTime, false, 0, 900),
        new Task(9, '', new Date(2018, 1, 1), 2, false, 0, false, false, TaskTypeEnum.NoTime, false, 0, 480),
        new Task(10, '', new Date(2018, 1, 1), 1, false, 0, false, false, TaskTypeEnum.NoTime, false, 0, 480),
        new Task(11, '', new Date(2018, 1, 1), 2, false, 0, false, false, TaskTypeEnum.AllDayLong),
        new Task(12, '', new Date(2018, 1, 1), 1, false, 0, false, false, TaskTypeEnum.AllDayLong)
    ]
